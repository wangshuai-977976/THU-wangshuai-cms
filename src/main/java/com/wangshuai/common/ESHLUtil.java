...
public class ESHLUtil<T>  {
	...
	// 查询操作2
	public static <T> ESHLUtil<T> selectPageObjects(Class<T> clazz, Integer page, Integer rows, String fieldNames[],
			String sortField, String value) {
